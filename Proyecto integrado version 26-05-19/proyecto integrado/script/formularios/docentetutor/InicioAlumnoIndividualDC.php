      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          ...
          <div class="row">
                  ...
                  <div class="panel panel-primary">
                    <div class="panel panel-primary">
                      <?php  
                        ...
                        $Mysql->Conectar();
                        $Consulta = "SELECT Fotografia from alumno where idAlumno='".$_SESSION['IdAlumnoDocenteTutor']."';";
            ...
            <div class="col-sm-5">
              <?php
                        $Consulta = "SELECT alumno.Nombre AS NombreAlumno,alumno.ApellidoP,alumno.ApellidoM, grupos.Grado, grupos.Grupo, carreras.Nombre AS NombreCarrera FROM alumno INNER JOIN grupos ON alumno.Grupos_idGrupos = grupos.idGrupos INNER JOIN carreras ON grupos.Carreras_idCarreras=carreras.idCarreras WHERE alumno.idAlumno='".$_SESSION['IdAlumnoDocenteTutor']."';";
                        $Resultado = $Mysql->Consulta($Consulta);
                        if ($Resultado->num_rows > 0) {//si la variable tiene al menos 1 fila entonces seguimos con el codigo
                          while ($row = $Resultado->fetch_array(MYSQLI_ASSOC)){
