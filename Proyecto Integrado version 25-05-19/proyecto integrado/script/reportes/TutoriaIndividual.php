...
$Consulta = "SELECT tutoriaindividual.Alumno_idAlumno,tutoriaindividual.NoTutoria,tutoriaindividual.FechaTutoria,tutoriaindividual.Horario,tutoriaindividual.ActividadesTareas, alumno.Nombre AS NombreAlumno, alumno.ApellidoP AS ApellidoPAlumno, alumno.ApellidoM AS ApellidoMAlumno,alumno.FechaNac, alumno.Sexo, grupos.Grupo, grupos.Grado, carreras.Nombre AS NombreCarrera, personal.Nombre, personal.ApellidoP, personal.ApellidoM FROM tutoriaindividual,personal, alumno, grupos,carreras WHERE tutoriaindividual.Alumno_idAlumno = '".$_SESSION['IdAlumnoDocenteTutor']."' and tutoriaindividual.idGrupo = grupos.idGrupos AND grupos.Carreras_idCarreras = carreras.idCarreras AND tutoriaindividual.idTutor = personal.idPersonal and tutoriaindividual.idTutoriaIndividual = '".$TutoriaIndividual."';";
