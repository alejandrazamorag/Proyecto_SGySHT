                ...
                <div class="tab-content">
                  ...
                  <div role="tabpanel" class="tab-pane fade" id="DE">
                    ...
                    <div class="row">
                      <div class=" col-md-12">
                        <b>a) Secundaria: </b>
                        <label for="">Secundaria General Ignacion Manuel Altamirano</label>
                        <b class="m-4">Promedio:</b><label for="">9.6</label>
                      </div>
                    </div>
                    <!--Final opcion a-->
                    <!--Inicio opcion b-->
                    ...
                    <div class="row">
                      <div class="col-12">
                        <b>c) ¿Actualmente realizas otro tipo de estudios?</b>
