...
$Resultado = $Mysql->Consulta($Consulta);
          ...
          <div id="form14">
            <label><b>14.-Cuando no puedo pensar en una palabra especifica especifica, uso mis manos y llamo al objeto "coso".</b></label><br>
          ...
          <div id="form23">
            <label><b>23.-Me resulta difícil crear crear imágenes en mi cabeza.</b></label><br>
