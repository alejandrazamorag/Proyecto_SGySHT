...
if (!isset($_SESSION)) { session_start(); }
   ...
   <div class="container" id="contenedor">
    ...
    <br><center><h2> Inicio de sesión capturista</h2></center>
    <!--Poner titulo o nombre -->
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
       ...
       if (!isset($_POST['Usuario']) | !isset($_POST['Contrasena'])) {      
        ?>
        <form method="POST" action="LoginCE.php" class="form-horizontal">
          <br><br>
        ...
        if ($SQLControlador -> IniciarSesionCE($Usuarios)){
          $_SESSION['LoggedinCAP'] = true;
          $_SESSION['NombreUsuarioCAP'] = $SQLControlador -> GetNombrePersonal($Usuarios);
          echo "<script language='javascript'>window.location = 'InicioCE.php'</script>";
        }else{
