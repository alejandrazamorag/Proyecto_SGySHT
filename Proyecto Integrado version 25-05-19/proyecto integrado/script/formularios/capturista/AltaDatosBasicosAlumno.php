...
<body>
  ...
  <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-sm-10">
            ...
            <?php if(!isset($_POST['NombreAlumno'])){?>
               <form action="AltaDatosBasicosAlumno" method="POST" onsubmit="return validar()">
                  <br>
                  <h4>Datos Alumno:</h4>
                  <b><i>Nombre(s):</i></b>
     ...
     <div class="form-check-inline">
         Si <input class="m-2" type="radio" value="O" name="Tratamiento"  onclick="TipoTratamiento.disabled = false" /></label>
         No <input class="m-2" type="radio" value="F" name="Tratamiento"  onclick="TipoTratamiento.disabled = true"/></label>
     </div>
     <br>
     <b><i>¿De que tipo?</i></b>
