...
if (!isset($_SESSION)) { session_start(); }
   ...
   <div class="container" id="contenedor">
    ...
    <br><center><h2> Inicio de sesión Docente</h2></center>
    <!--Poner titulo o nombre -->
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
       ...
       if (!isset($_POST['Usuario']) | !isset($_POST['Contrasena'])) {      
        ?>
        <form method="POST" action="LoginDocente.php" class="form-horizontal">
          <br><br>
        ...
        if ($SQLControlador -> IniciarSesionDocente($Usuarios)){
          $_SESSION['LoggedinDocente'] = true;
          $_SESSION['NombreUsuarioDocente'] = $SQLControlador -> GetNombrePersonal($Usuarios);
          $_SESSION['IdUsuarioDocente'] = $SQLControlador -> GetIdPersonal($Usuarios);
