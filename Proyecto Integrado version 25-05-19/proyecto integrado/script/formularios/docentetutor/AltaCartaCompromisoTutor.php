          ...
          while ($fila = $Resultado->fetch_assoc()) {
            ...
            <div align="justify">
              ...
              <select  name="idFamiliar" class="m-1 custom-select"> 
                ...
                $Mysql = new MySQLConector();
                $Mysql->Conectar();
                $Consulta2 = "SELECT familiares.idFamiliares, familiares.Nombre, familiares.ApellidoP, familiares.ApellidoM FROM familiares WHERE familiares.Alumno_idAlumno = '1' AND familiares.Tutor = '1';";
