...
<body>
 ...
 <div class="container">
  ...
  <br><center><h2> Tabla Cartas responsivas</h2></center>
  <!--Poner titulo o nombre -->
  <br>
  <div class="row">
    <div class="col-sm-3">
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#buscador').load('../../clases/tablasmodales/BuscadorCartasResponsivas.php');
    $('#tabla').load('../../clases/tablasmodales/TablaCartasResponsivas.php');
